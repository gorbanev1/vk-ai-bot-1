...
const env = {
    OPENAI_API_KEY_1: 'TEST_OPENAI_FOREIGN_VALID_1234567890',
    OPENAI_API_KEY_2: 'TEST_OPENAI_FOREIGN_DEAD_1234567890',
    OPENAI_COMPAT_API_KEY: 'TEST_ROUTER_OWNER_MUST_NOT_AUDIT',
